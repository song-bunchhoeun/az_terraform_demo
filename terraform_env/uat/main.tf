...
#   name                = "redis-ekyc-${random_string.redis_suffix.result}"
#   resource_group_name = azurerm_resource_group.rg.name
#   location            = azurerm_resource_group.rg.location
...
#   name                = "pe-sql-dev-ekyc-sea-001"
#   location            = azurerm_resource_group.rg.location
#   resource_group_name = azurerm_resource_group.rg.name
#   subnet_id           = azurerm_subnet.subnet1.id

#   private_service_connection {
#     name                           = "psc-sql-dev-ekyc-sea-001"
...
#     name                 = "pdzg-sql-dev-ekyc-sea-001"
...
#   name                = "pe-sql-uat-ekyc-sea-001"
#   location            = azurerm_resource_group.rg.location
#   resource_group_name = azurerm_resource_group.rg.name
#   subnet_id           = azurerm_subnet.subnet2.id
#   private_service_connection {
#     name                           = "psc-sql-uat-ekyc-sea-001"
...
#   private_dns_zone_group {
#     name                 = "pdzg-sql-uat-ekyc-sea-001"
#     private_dns_zone_ids = [azurerm_private_dns_zone.sql.id]
#   }
# }

# resource "azurerm_private_endpoint" "redis" {
#   name                = "pe-redis-ekyc-sea-001"
#   location            = azurerm_resource_group.rg.location
#   resource_group_name = azurerm_resource_group.rg.name
#   subnet_id           = azurerm_subnet.subnet3.id

#   private_service_connection {
#     name                           = "psc-redis-ekyc-sea-001"
